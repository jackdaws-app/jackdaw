...
An account is not needed to view price history or to contribute price observations. It is required to post comments, vote, report, and set price alerts. If you create one:
