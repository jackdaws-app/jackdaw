...
- **We collect your email address**, used to send you a sign-in code and, if you enable it, alerts for the products you are watching. Email alerts are off until you turn them on, from the extension's toolbar popup; every message we send carries a link that turns them off again, and using that link requires no account and no sign-in. We do not use your address for marketing, we do not send advertising or sponsored content, and we do not share or sell it.
